...
public class TripleDesView {
    TripleDesView() {
        JFrame frame = new JFrame("Encrypt Your Text in TripleDES");
        JPanel panel_top = new JPanel();
        JPanel panel_middle = new JPanel();
        JPanel panel_down = new JPanel();

        JLabel label_desc = new JLabel("Input your text and Click on encrypt to begin encryption");
        ...
        JMenuItem m_copy_cipherText = new JMenuItem("Copy Given data");
        ...
        panel_middle.add(label_DECTEXT);
        panel_middle.add(label_dectext);
        panel_middle.setLayout(null);
        panel_middle.setBackground(Color.white);

        butt_back.setBounds(50, 50, 80, 30);
        butt_clear.setBounds(180, 50, 80, 30);
        butt_encrypt.setBounds(300, 50, 80, 30);
        butt_decrypt.setBounds(400,50,80,30);
        ...
        butt_encrypt.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (tf_text.getText().trim().equals(""))
                    ...
                    TripleDES_backend ob=new TripleDES_backend();
                    ob.encrypt(tf_text.getText());
                    ob.getCipherText();
                    label_key.setText(ob.getKey1());
                    label_key2.setText(ob.getKey2());
                    label_key3.setText(ob.getKey3());
                    label_ctext.setText(ob.getCipherText());
                    ob.getCipherBtye();
                    JOptionPane.showMessageDialog(null,"Encrypted in DES");
                }
            }
        });
        ...
        m_copy_cipherText.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Clipboard ob=new Clipboard(label_key.getText(),label_key2.getText(),label_key3.getText(),label_ctext.getText());
                ob.viewClipboard();
            }
        });
